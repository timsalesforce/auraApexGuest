...
*/
/* LWR Legacy Module Loader Shim v0.10.10 */
(function () {
  'use strict';
  ...
  class LoaderShim {
      ...
      constructor(global) {LoaderShim.prototype.__init.call(this);LoaderShim.prototype.__init2.call(this);
          ...
          this.loaderModule = 'lwr/loaderLegacy/v/0_10_10';
      ...
      // Note: The profiler is also available as a module through lwc module resolution (see package.json)
       createProfilerModule(globalLWR) {
          ...
          globalLWR.define('lwr/profiler/v/0_10_10', ['exports'], exporter, {});
      }
  ...
  if (GLOBAL.LWR.requiredModules.indexOf('lwr/loaderLegacy/v/0_10_10') < 0) {
      GLOBAL.LWR.requiredModules.push('lwr/loaderLegacy/v/0_10_10');
  }
...
LWR.define('lwr/loaderLegacy/v/0_10_10', ['exports'], (function (exports) { 'use strict';
